...
-- if getgenv().LOADED == true then return end
-- getgenv().LOADED = true
getgenv().MAIN_COLOR = Color3.fromRGB(140, 255, 90)

--! file generated by dooms GUI TO LUA : V2.0.0 
...
local Background = add("Frame", { Parent = ProfilePicture, Name = [[Background]], AnchorPoint = Vector2.new(0.5, 0.5), BorderSizePixel = 0, Size = UDim2.new(0, 32, 0, 32), BorderColor3 = Color3.fromRGB(0, 0, 0), Position = UDim2.new(0.5, 0, 0.5, 0), BackgroundColor3 = Color3.fromRGB(255, 255, 255),})
...
local ImageLabel = add("ImageLabel", { Parent = ProfilePicture, Image = [[rbxthumb://type=AvatarHeadShot&id=1&w=420&h=420]], BorderSizePixel = 0, Size = UDim2.new(1, 0, 1, 0), BorderColor3 = Color3.fromRGB(0, 0, 0), BackgroundTransparency = 1, BackgroundColor3 = Color3.fromRGB(255, 255, 255),})
...
local UserLabel = add("TextLabel", { Parent = ProfileCard, Name = [[UserLabel]], TextWrapped = true, TextTruncate = Enum.TextTruncate.AtEnd, BorderSizePixel = 0, TextYAlignment = Enum.TextYAlignment.Bottom, BackgroundColor3 = Color3.fromRGB(255, 255, 255), TextSize = 14, Size = UDim2.new(1, -45, 0, 17), TextXAlignment = Enum.TextXAlignment.Left, BorderColor3 = Color3.fromRGB(0, 0, 0), Text = [[20CharactersMaxxx]], FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal), Position = UDim2.new(0.357798159, 0, 0.13333334, 0), TextColor3 = Color3.fromRGB(165, 165, 165), BackgroundTransparency = 1,})
...
--[[		 SCRIPTS		]]--
local FakeScript = add("LocalScript", { Parent = ProfileCard, Name = [[LoadData]],})
task.spawn(function()
	...
	script.Parent.UserLabel.Text = Player.DisplayName
	script.Parent.StatusLabel.Text = 'Seller'
	script.Parent.ProfilePicture.Background.BackgroundColor3 = getgenv().MAIN_COLOR
	script.Parent.ProfilePicture.ImageLabel.Image = Players:GetUserThumbnailAsync(
		Player.UserId,
		Enum.ThumbnailType.HeadShot,
		Enum.ThumbnailSize.Size420x420
	)
	
	if getgenv().Alts and getgenv().Alts[Player.UserId] then
		script.Parent.StatusLabel.Text = 'Alt'
	end
end)
